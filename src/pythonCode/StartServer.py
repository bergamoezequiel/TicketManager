...
api.add_resource(Funciones, "/Funciones") #http://192.168.0.13:5000:5000/Funciones?cuitEmp=30-69726350-7&IdEspectaculo=1-SPIDER ejemplo de invocacion
api.add_resource(Espectaculos,"/Espectaculos") #Espectaculos por empresa	http://192.168.0.13:5000:5000/Espectaculos?cuitEmp=30-69726350-7
api.add_resource(Entradas,"/Entradas")
api.add_resource(Intereses,"/Intereses")
api.add_resource(InfoCompletaEntradas,"/InformacionCompleta/Entradas")#http://192.168.0.13:5000:5000/InformacionCompleta/Entradas?IdCliente=1
